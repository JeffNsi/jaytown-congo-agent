...
_Generated (UTC): 2026-09-12_1833_

## Executive Summary

- CATON: needs-more-data
- SIDEQUEST: needs-more-data
- USEFUL: asymmetric-opportunity-candidate
- MM: red-flags
- Udin: asymmetric-opportunity-candidate
...
### CATON (solana, `9yxCEKQztXKNV7By3VUNeRYa214ukFCQfb6a8XYZ6M4V`)
...
### SIDEQUEST (solana, `2Uu92v6oNWehRopdyyoxzxfT7b9Akbw4YGzGXSwAdALL`)
...
**Narrative proxy**: 0 recent web/news mention(s) found for the query `"SIDE QUEST GUY" SIDEQUEST solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
...
### USEFUL (solana, `GWTP6M5bxhaJ1k2Kxvf8hhYaHE6jZMhh4cKzFuCpnc83`)
...
- Liquidity: $139,483
- 24h volume: $480,592
- Pair age: 171.2 hours
- FDV/MarketCap ratio: 1.0
- Declared socials: 1 link(s)

**Signals**
- Volume/liquidity ratio 3.45x -- within a normal range.
- Buy/sell ratio (24h): 1.71x (buy-skewed)
...
**Narrative proxy**: 0 recent web/news mention(s) found for the query `"USEFUL COIN" USEFUL solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
...
### MM (solana, `zzjkh1hLbvsFJXWLfE6h4JNbcnRj4eteuKRw42PN2tC`)

_Discovery source: boosted -- PAID PROMOTION_

**Facts**
- Liquidity: $86,514
- 24h volume: $1,655,668
- Pair age: 76.0 hours
- FDV/MarketCap ratio: 1.0
- Declared socials: 1 link(s)

**Signals**
- Volume/liquidity ratio 19.14x in 24h -- unusually high relative to pool depth; can indicate wash trading or bot activity as easily as genuine demand. Not automatically bullish.
...
**Narrative proxy**: 1 recent web/news mention(s) found for the query `"Meme Man" MM solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
...
**Verdict**: red-flags -- volume/liquidity ratio of 19.14x is extreme and consistent with wash trading.

### Udin (solana, `2aQKC1xiKpEyAWvzSDrULnYLVuybWyx7qrsnpP8hpump`)
...
**Narrative proxy**: 0 recent web/news mention(s) found for the query `"Udin din din dun" Udin solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
