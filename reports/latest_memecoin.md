...
_Generated (UTC): 2026-09-22_1333_

## Executive Summary

- LOOP: asymmetric-opportunity-candidate
- PUMPCAT: red-flags
- PROBLEM: needs-more-data
- KCAT: red-flags
- STONKY: needs-more-data
...
### LOOP (solana, `HunmXDXMNQYVoDnUL6PNnSYEtFaTZA2WzGh1HJTW7aoV`)
...
- Liquidity: $25,697
- 24h volume: $22,556
- Pair age: 274.6 hours
- FDV/MarketCap ratio: 1.0
- Declared socials: 1 link(s)

**Signals**
- Volume/liquidity ratio 0.88x -- within a normal range.
- Buy/sell ratio (24h): 0.98x (balanced)
...
### PUMPCAT (solana, `DFQHUegJWE29Xu3BUxPezqi77uyHURRyxJpdtyvLpump`)
...
**Signals**
- Volume/liquidity ratio 16.0x in 24h -- unusually high relative to pool depth; can indicate wash trading or bot activity as easily as genuine demand. Not automatically bullish.
...
**Narrative proxy**: 8 recent web/news mention(s) found for the query `"PUMP CAT" PUMPCAT solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
...
**Verdict**: red-flags -- volume/liquidity ratio of 16.0x is extreme and consistent with wash trading.

### PROBLEM (solana, `BbAgaENCJ1jg5RmH3WMbZUf6enu1bLSd33QNXXExpump`)
...
**Signals**
- Buy/sell ratio (24h): 2.4x (buy-skewed)
...
**Narrative proxy**: 0 recent web/news mention(s) found for the query `"CATWIFPROBLEM" PROBLEM solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
...
### KCAT (solana, `MboMMGXjGDi45hfjCVzYru32kEM5nw7VzCqCofZpump`)

_Discovery source: boosted -- PAID PROMOTION_

**Facts**
- Liquidity: $56,350
- 24h volume: $1,832,961
- Pair age: 3.2 hours
- FDV/MarketCap ratio: 1.0
- Declared socials: 1 link(s)

**Signals**
- Volume/liquidity ratio 32.53x in 24h -- unusually high relative to pool depth; can indicate wash trading or bot activity as easily as genuine demand. Not automatically bullish.
- Buy/sell ratio (24h): 1.38x (buy-skewed)
- Pair is under 24h old -- too early for any growth-acceleration claim; treat as unknown-stage.
...
**Narrative proxy**: 0 recent web/news mention(s) found for the query `"Karate Cat " KCAT solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
...
**Verdict**: red-flags -- volume/liquidity ratio of 32.53x is extreme and consistent with wash trading.

### STONKY (solana, `H133TpJVPTKeA7AWtvgQ15zKegPBDgGPaGdX94UgJ8sq`)
...
**Signals**
- Volume/liquidity ratio 11.27x in 24h -- unusually high relative to pool depth; can indicate wash trading or bot activity as easily as genuine demand. Not automatically bullish.
- Buy/sell ratio (24h): 1.49x (buy-skewed)
- Pair is under 24h old -- too early for any growth-acceleration claim; treat as unknown-stage.
...
**Narrative proxy**: 0 recent web/news mention(s) found for the query `"Stonky" STONKY solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
