...
- BONZI: red-flags
- REKT: needs-more-data
- PUMPLIFE: red-flags
- memelord: needs-more-data
- PAСKD: red-flags
...
### BONZI (solana, `A6PVnMVFm3tFCjz3FDwWDR7YcUEqfe5wRSkawaEFpump`)
...
**Narrative proxy**: 0 recent web/news mention(s) found for the query `"CRYPTO-SAURUS-REKT" REKT solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
...
### PUMPLIFE (solana, `5761e8gCMZFBHLU4RuFsfkWab96oJEtEr3uoF9A4pump`)
...
**Narrative proxy**: 8 recent web/news mention(s) found for the query `"Pump Life" PUMPLIFE solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
...
**Narrative proxy**: 0 recent web/news mention(s) found for the query `"the memelord" memelord solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
...
### PAСKD (solana, `UhqVqBBxp7esoWrHeQo6Q3XkwDTMfUJLogNbNoopump`)
...
**Narrative proxy**: 0 recent web/news mention(s) found for the query `"PACKD" PAСKD solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
