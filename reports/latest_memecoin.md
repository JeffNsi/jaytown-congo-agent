...
_Generated (UTC): 2026-09-19_1118_

## Executive Summary

- M$TF: needs-more-data
- GGWP: needs-more-data
- BITDOG: needs-more-data
- PSA10: red-flags
- $BULL: needs-more-data
...
### M$TF (solana, `Cq5NZrjSYrk2P9NqkjS1YffkHyx8XaUqYX1Ho7PGjesS`)
...
- Liquidity: $14,662
- 24h volume: $979
- Pair age: 8576.6 hours
- FDV/MarketCap ratio: 1.0
- Declared socials: 1 link(s)

**Signals**
- Volume/liquidity ratio 0.07x -- within a normal range.
- Buy/sell ratio (24h): 2.5x (buy-skewed)
...
### GGWP (solana, `671HGnyBtSdL9D6W4684nuARBWCZDN9gK7HidDsKGgwP`)
...
**Signals**
- Volume/liquidity ratio 0.79x -- within a normal range.
- Buy/sell ratio (24h): 1.92x (buy-skewed)
...
**Narrative proxy**: 5 recent web/news mention(s) found for the query `"GGWP" GGWP solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
...
### BITDOG (solana, `B3jjDNkBw48utaFxRRSWxg4oUkN23YxodChdEf4bxhQS`)
...
**Signals**
- Volume/liquidity ratio 5.51x in 24h -- unusually high relative to pool depth; can indicate wash trading or bot activity as easily as genuine demand. Not automatically bullish.
- Buy/sell ratio (24h): 1.63x (buy-skewed)
...
**Narrative proxy**: 0 recent web/news mention(s) found for the query `"BITCOIN DOG" BITDOG solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
...
### PSA10 (solana, `DnJeAP7hWjVNTTk1NUaDJ5Aps9qDroSsEMcKBCpSTNK`)

_Discovery source: boosted -- PAID PROMOTION_

**Facts**
- Liquidity: $76,729
- 24h volume: $1,205,196
- Pair age: 3.8 hours
- FDV/MarketCap ratio: 1.0
- Declared socials: 1 link(s)

**Signals**
- Volume/liquidity ratio 15.71x in 24h -- unusually high relative to pool depth; can indicate wash trading or bot activity as easily as genuine demand. Not automatically bullish.
- Buy/sell ratio (24h): 1.34x (buy-skewed)
- Pair is under 24h old -- too early for any growth-acceleration claim; treat as unknown-stage.
...
**Narrative proxy**: 3 recent web/news mention(s) found for the query `"PSA10 Coin" PSA10 solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
...
**Verdict**: red-flags -- volume/liquidity ratio of 15.71x is extreme and consistent with wash trading.

### $BULL (solana, `HHHsPNkxkrF56xf3cvQjv9KSniQFUdk4vdo4q2HpDqLC`)
...
**Signals**
- Volume/liquidity ratio 0.6x -- within a normal range.
- Buy/sell ratio (24h): 1.81x (buy-skewed)
...
**Narrative proxy**: 3 recent web/news mention(s) found for the query `"Bullion" $BULL solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
