...
_Generated (UTC): 2026-09-23_0048_

## Executive Summary

- CTO: asymmetric-opportunity-candidate
- BOTC: needs-more-data
- YES: asymmetric-opportunity-candidate
- PATTY: needs-more-data
- Tokens: red-flags
...
### CTO (solana, `EWgq2xUb6eVCApeQombkPxd6uFjM8j9zRUXFS9MjKTiv`)
...
- Liquidity: $57,543
- 24h volume: $263,272
- Pair age: 323.6 hours
- FDV/MarketCap ratio: 1.0
- Declared socials: 1 link(s)

**Signals**
- Volume/liquidity ratio 4.58x -- within a normal range.
- Buy/sell ratio (24h): 0.88x (balanced)
...
### BOTC (solana, `GXzDKW96ZzdmxKVGPngP9jeNXWSrriosap9e5azZpump`)
...
- Liquidity: $8,651
- 24h volume: $241
- Pair age: 4231.0 hours
- FDV/MarketCap ratio: 1.0
- Declared socials: 1 link(s)

**Signals**
- Volume/liquidity ratio 0.03x -- within a normal range.
- Buy/sell ratio (24h): 0.77x (balanced)
...
**Narrative proxy**: 0 recent web/news mention(s) found for the query `"Botcoin" BOTC solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
...
### YES (solana, `VzqFToxrHqs7BFtfWvwmGAn6nv7p9W3zdmW95iTpump`)
...
- Liquidity: $148,989
- 24h volume: $472,466
- Pair age: 305.5 hours
- FDV/MarketCap ratio: 1.0
- Declared socials: 1 link(s)

**Signals**
- Volume/liquidity ratio 3.17x -- within a normal range.
...
**Narrative proxy**: 0 recent web/news mention(s) found for the query `"YesBlob" YES solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
...
### PATTY (solana, `2uAShfWGvJ1uwHQ4gftsvoYXdayK2hwDQZXTFnmhpump`)
...
**Narrative proxy**: 0 recent web/news mention(s) found for the query `"Supreme Patty" PATTY solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
...
### Tokens (solana, `C3b3fpyRWsJf3bo6vay2vo1bQ7CezwumZwTrP82Lpump`)

_Discovery source: boosted -- PAID PROMOTION_

**Facts**
- Liquidity: $56,291
- 24h volume: $1,476,645
- Pair age: 76.4 hours
- FDV/MarketCap ratio: 1.0
- Declared socials: 1 link(s)

**Signals**
- Volume/liquidity ratio 26.23x in 24h -- unusually high relative to pool depth; can indicate wash trading or bot activity as easily as genuine demand. Not automatically bullish.
- Buy/sell ratio (24h): 1.25x (balanced)
...
**Narrative proxy**: 8 recent web/news mention(s) found for the query `"Tokens" Tokens solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
...
**Verdict**: red-flags -- volume/liquidity ratio of 26.23x is extreme and consistent with wash trading.
