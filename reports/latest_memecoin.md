...
_Generated (UTC): 2026-09-22_2132_

## Executive Summary

- XRP: needs-more-data
- TIKCAT: needs-more-data
- bbtc: needs-more-data
- PENNY: needs-more-data
- GTACAT: needs-more-data
...
### XRP (solana, `BSZR7tCG2KefQNVzcJbcmdiLoqmsf5hdhwoL6W8tuEbZ`)
...
- Liquidity: $21,197
- 24h volume: $167,729
- Pair age: 325.6 hours
- FDV/MarketCap ratio: 1.0
- Declared socials: 2 link(s)

**Signals**
- Volume/liquidity ratio 7.91x in 24h -- unusually high relative to pool depth; can indicate wash trading or bot activity as easily as genuine demand. Not automatically bullish.
...
### TIKCAT (solana, `BeqTt4qqhH4qjgA6wN2dxjzM5M7qgabiTnT8apm4pump`)
...
**Signals**
- Volume/liquidity ratio 8.8x in 24h -- unusually high relative to pool depth; can indicate wash trading or bot activity as easily as genuine demand. Not automatically bullish.
- Buy/sell ratio (24h): 5.33x (buy-skewed)
...
**Narrative proxy**: 0 recent web/news mention(s) found for the query `"TikTok Cat" TIKCAT solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
...
### bbtc (solana, `BJvb2NzHwTbTK64qvarRutp48qicwEWUCHmnpidJYBMb`)
...
- Liquidity: $6,832
- 24h volume: $380
- Pair age: 15095.8 hours
- FDV/MarketCap ratio: 1.0
- Declared socials: 4 link(s)

**Signals**
- Volume/liquidity ratio 0.06x -- within a normal range.
- Buy/sell ratio (24h): 2.67x (buy-skewed)
...
**Narrative proxy**: 0 recent web/news mention(s) found for the query `"Blue Bitcoin " bbtc solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
...
### PENNY (solana, `2jjbtFBnsZNqgNR3N3LVbDtVCLKHK23w3MZzr4a5PooH`)
...
**Signals**
- Volume/liquidity ratio 6.3x in 24h -- unusually high relative to pool depth; can indicate wash trading or bot activity as easily as genuine demand. Not automatically bullish.
...
**Narrative proxy**: 3 recent web/news mention(s) found for the query `"Penny Stonk" PENNY solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
...
### GTACAT (solana, `AvciVw95QA2nrPrwFYCLsp3n425MPCuF8iFU5BZrpump`)
...
**Signals**
- Volume/liquidity ratio 7.54x in 24h -- unusually high relative to pool depth; can indicate wash trading or bot activity as easily as genuine demand. Not automatically bullish.
- Buy/sell ratio (24h): 0.32x (sell-skewed)
- Liquidity under $10k -- high slippage/rug risk regardless of other metrics.
- Pair is under 24h old -- too early for any growth-acceleration claim; treat as unknown-stage.
...
**Narrative proxy**: 0 recent web/news mention(s) found for the query `"Tilcayo Perico Heist Cat" GTACAT solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
