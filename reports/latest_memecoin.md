...
_Generated (UTC): 2026-09-07_0009_

## Executive Summary

- B4P: needs-more-data
- KITTY: red-flags
- ZDOG: needs-more-data
- BABYZCAT: red-flags
- GHRD: needs-more-data
...
### B4P (solana, `Apt9tCrb1CuD2XU4ws5CZxpxAU8QwEBsVd3DFq6npump`)
...
### KITTY (solana, `AgynNPK4YZvDPrscpZnhWBHC9n7d8e48Hs7rzVh3RW9d`)
...
**Signals**
- Volume/liquidity ratio 0.09x -- within a normal range.
...
**Narrative proxy**: 3 recent web/news mention(s) found for the query `"ROARING KITTY" KITTY solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
...
### ZDOG (solana, `EbT2jpoeRJVFNWAFJE97EGfQF3iwHsEY8sh17fGbL5ER`)

_Discovery source: boosted -- PAID PROMOTION_

**Facts**
- Liquidity: $336,086
- 24h volume: $2,273,002
- Pair age: 167.7 hours
- FDV/MarketCap ratio: 1.0
- Declared socials: none listed

**Signals**
- Volume/liquidity ratio 6.76x in 24h -- unusually high relative to pool depth; can indicate wash trading or bot activity as easily as genuine demand. Not automatically bullish.
...
**Narrative proxy**: 0 recent web/news mention(s) found for the query `"Anonymous Dog" ZDOG solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
...
**Signals**
- Volume/liquidity ratio 40.05x in 24h -- unusually high relative to pool depth; can indicate wash trading or bot activity as easily as genuine demand. Not automatically bullish.
- Buy/sell ratio (24h): 1.36x (buy-skewed)
- Pair is under 24h old -- too early for any growth-acceleration claim; treat as unknown-stage.
...
**Verdict**: red-flags -- volume/liquidity ratio of 40.05x is extreme and consistent with wash trading.

### GHRD (solana, `3ZqTR9uGBdWhUT6yrLmqmQaaTetxe387mph3geXq6QUt`)
...
**Narrative proxy**: 0 recent web/news mention(s) found for the query `"GIGAHARD" GHRD solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
