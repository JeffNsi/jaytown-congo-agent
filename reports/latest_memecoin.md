...
_Generated (UTC): 2026-09-20_1232_

## Executive Summary

- PAFT: needs-more-data
- STONKCAT: asymmetric-opportunity-candidate
- SOLMINTAUR: needs-more-data
- BOBI: needs-more-data
- TIGRINO: red-flags
...
### STONKCAT (solana, `DkPQvrx7CDYrL4HfHijz6GqZLYm7Pd4rm1kTiumLFwhS`)
...
- Liquidity: $868,892
- 24h volume: $208,338
- Pair age: 658.0 hours
- FDV/MarketCap ratio: 1.0
- Declared socials: 2 link(s)

**Signals**
- Volume/liquidity ratio 0.24x -- within a normal range.
...
**Narrative proxy**: 0 recent web/news mention(s) found for the query `"Stonk Cat" STONKCAT solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
...
### SOLMINTAUR (solana, `CazLeEfcs6r7Sh7p6ixkkjoMiE5DiEsnzzhZAkS1pump`)
...
**Signals**
- Buy/sell ratio (24h): 2.15x (buy-skewed)
...
**Narrative proxy**: 0 recent web/news mention(s) found for the query `"The Solana Minotaur" SOLMINTAUR solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
...
### BOBI (solana, `4oXgAtYRvgLYtN5PWqKesCP7pHVjLmgvEpwuDh4qLygJ`)
...
**Signals**
- Buy/sell ratio (24h): 2.11x (buy-skewed)
- Pair is under 24h old -- too early for any growth-acceleration claim; treat as unknown-stage.
...
**Narrative proxy**: 0 recent web/news mention(s) found for the query `"BobiBird" BOBI solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
...
### TIGRINO (solana, `91ryaCo5yGpYZM3bs6GUPs97VWJQj7RozBmqPULgpump`)

_Discovery source: boosted -- PAID PROMOTION_

**Facts**
- Liquidity: $199,356
- 24h volume: $3,968,958
- Pair age: 49.4 hours
- FDV/MarketCap ratio: 1.0
- Declared socials: 3 link(s)

**Signals**
- Volume/liquidity ratio 19.91x in 24h -- unusually high relative to pool depth; can indicate wash trading or bot activity as easily as genuine demand. Not automatically bullish.
...
**Narrative proxy**: 1 recent web/news mention(s) found for the query `"Leopardus Tilcayo" TIGRINO solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
...
**Verdict**: red-flags -- volume/liquidity ratio of 19.91x is extreme and consistent with wash trading.
