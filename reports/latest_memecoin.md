...
_Generated (UTC): 2026-09-16_0621_

## Executive Summary

- three: asymmetric-opportunity-candidate
- xNicki: needs-more-data
- LAMA: asymmetric-opportunity-candidate
- UNITY: needs-more-data
- BOT: red-flags
...
### three (solana, `FeMbDoX7R1Psc4GEcvJdsbNbZA3bfztcyDCatJVJpump`)
...
- Liquidity: $210,925
- 24h volume: $141,606
- Pair age: 3359.2 hours
- FDV/MarketCap ratio: 1.0
- Declared socials: 1 link(s)

**Signals**
- Volume/liquidity ratio 0.67x -- within a normal range.
- Buy/sell ratio (24h): 1.77x (buy-skewed)
...
### xNicki (solana, `B3ME8RQhjebdNQeXBeZH3RXHX1BMpT3uAMPxbeDCpump`)
...
**Signals**
- Buy/sell ratio (24h): 1.48x (buy-skewed)
...
**Narrative proxy**: 0 recent web/news mention(s) found for the query `"QUEEN OF RAP" xNicki solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
...
### LAMA (solana, `2fWzx35rQMAATQGhJzVTvzeXHcenCQLqCog9Jkg5pump`)
...
**Signals**
- Volume/liquidity ratio 4.69x -- within a normal range.
- Buy/sell ratio (24h): 0.83x (balanced)
...
**Narrative proxy**: 0 recent web/news mention(s) found for the query `"LAMA Pay" LAMA solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
...
### UNITY (solana, `HirVitxn98jZZgakMKjvbJshCMCfbJcw1CbVREPTpump`)
...
**Narrative proxy**: 0 recent web/news mention(s) found for the query `"Galactic Federation" UNITY solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
...
### BOT (solana, `933HLc6SPfxkFwiPXwCksmcSHvVBDzeC4A1SafRVpaid`)
...
**Signals**
- Volume/liquidity ratio 52.11x in 24h -- unusually high relative to pool depth; can indicate wash trading or bot activity as easily as genuine demand. Not automatically bullish.
- Buy/sell ratio (24h): 1.28x (balanced)
- Pair is under 24h old -- too early for any growth-acceleration claim; treat as unknown-stage.
...
**Narrative proxy**: 8 recent web/news mention(s) found for the query `"Bot" BOT solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
...
**Verdict**: red-flags -- volume/liquidity ratio of 52.11x is extreme and consistent with wash trading.
