...
_Generated (UTC): 2026-09-17_1340_

## Executive Summary

- FC: needs-more-data
- ANALOS: asymmetric-opportunity-candidate
- UNISHIT: needs-more-data
- UNITY: needs-more-data
- MEMEBID: needs-more-data
...
### FC (solana, `FPfxePFmQAVAEsMUrs6d4qHT2X6HRS7edMrNh2hspump`)
...
**Signals**
- Buy/sell ratio (24h): 0.96x (balanced)
...
### ANALOS (solana, `5Z1xHaFjMUDmnmBGi6ckvZXEq4oSYNjkEdLyXvzqVG1V`)
...
- Liquidity: $48,174
- 24h volume: $100,131
- Pair age: 903.3 hours
- FDV/MarketCap ratio: 1.0
- Declared socials: 1 link(s)

**Signals**
- Volume/liquidity ratio 2.08x -- within a normal range.
- Buy/sell ratio (24h): 2.51x (buy-skewed)
...
**Narrative proxy**: 0 recent web/news mention(s) found for the query `"ANALOS" ANALOS solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
...
### UNISHIT (solana, `2zKnHg8Cw2h4rE3x2iRo35sBrAYAPmqK29NkFS4opump`)
...
**Narrative proxy**: 0 recent web/news mention(s) found for the query `"UNISHIT" UNISHIT solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
...
- Liquidity: unavailable
- 24h volume: $1,170
- Pair age: 111.7 hours
- FDV/MarketCap ratio: 1.0
- Declared socials: none listed

**Signals**
- Buy/sell ratio (24h): 0.93x (balanced)
...
### MEMEBID (solana, `9CHnozHgtQVCYu6Z7SzWkxdNJEdMy8Tt3bh7B2wQpump`)
...
**Signals**
- Volume/liquidity ratio 12.39x in 24h -- unusually high relative to pool depth; can indicate wash trading or bot activity as easily as genuine demand. Not automatically bullish.
...
**Narrative proxy**: 0 recent web/news mention(s) found for the query `"MemeBID" MEMEBID solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
