...
_Generated (UTC): 2026-09-26_0147_

## Executive Summary

- TUPELO: needs-more-data
- DRMR: needs-more-data
- METACAT: needs-more-data
- Boolish: needs-more-data
- Phug: needs-more-data
...
### TUPELO (solana, `2N34WqRjdTwefoy5SqsHBomPArWW2avmho5ifW9tDKQ7`)
...
- Liquidity: $7,291
- 24h volume: $2,969
- Pair age: 236.9 hours
- FDV/MarketCap ratio: 1.0
- Declared socials: 1 link(s)

**Signals**
- Volume/liquidity ratio 0.41x -- within a normal range.
...
### DRMR (solana, `7Xgc5RacHtGzfhw2HukUBk5V986yBbvshr7rrCoopump`)
...
**Signals**
- Volume/liquidity ratio 7.53x in 24h -- unusually high relative to pool depth; can indicate wash trading or bot activity as easily as genuine demand. Not automatically bullish.
...
**Narrative proxy**: 0 recent web/news mention(s) found for the query `"DerekMercer" DRMR solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
...
### METACAT (solana, `6i5MkY8G51Kki1iAus8VAi7quBbRTkUWAojUoT7mpump`)
...
**Signals**
- Buy/sell ratio (24h): 1.57x (buy-skewed)
...
**Narrative proxy**: 0 recent web/news mention(s) found for the query `"METACAT" METACAT solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
...
### Boolish (solana, `8KM9zfpHkV53fir6qMaWpU4ZiqYp4axVNtRd7GLNpump`)
...
**Narrative proxy**: 8 recent web/news mention(s) found for the query `"Boolish" Boolish solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
...
### Phug (solana, `Fi771FZhXqu75DP6c7CypFixC8s6mVcuimm4to3Dpump`)
...
**Signals**
- Buy/sell ratio (24h): 1.37x (buy-skewed)
- Pair is under 24h old -- too early for any growth-acceleration claim; treat as unknown-stage.
...
**Narrative proxy**: 0 recent web/news mention(s) found for the query `"Phug" Phug solana memecoin`. This measures indexed mentions, not community size, growth rate, or authenticity -- AND the ticker alone is not a unique identifier (many memecoins reuse common tickers), so even with the token name and chain added to the query, individual results are not verified to be about this specific contract address. Treat this count as an unverified, easily-mismatched proxy, not confirmed attribution.
